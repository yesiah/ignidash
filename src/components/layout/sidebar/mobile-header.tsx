...
export default function MobileHeader({ onMenuClick, currentPageTitle, currentPageIcon: Icon }: MobileHeaderProps) {
  ...
  return (
    <div className="from-emphasized-background to-background border-border/50 fixed top-0 z-40 flex w-full items-center gap-x-6 border-b border-dashed bg-gradient-to-l px-4 py-4 sm:px-6 lg:hidden">
