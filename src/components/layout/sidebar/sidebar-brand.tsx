...
export default function SidebarBrand({ onClose }: SidebarBrandProps) {
  return (
    <div className="border-border/50 from-emphasized-background relative -mx-3 flex items-center justify-between gap-2 overflow-hidden border-b bg-gradient-to-br to-rose-500/35 py-4 group-data-[state=collapsed]/sidebar:py-[0.875rem]">
      ...
      <div className="pointer-events-none absolute inset-0 flex w-full items-center justify-center opacity-0 transition-opacity duration-200 ease-out group-data-[state=collapsed]/sidebar:pointer-events-auto group-data-[state=collapsed]/sidebar:opacity-100">
        <SidebarToggle />
      </div>
      {/* Expanded view - logo + brand + toggle */}
      <div className="mx-3 flex w-full items-center justify-between opacity-100 transition-opacity duration-200 ease-out group-data-[state=collapsed]/sidebar:pointer-events-none group-data-[state=collapsed]/sidebar:opacity-0">
