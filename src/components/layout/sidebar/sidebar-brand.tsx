...
export default function SidebarBrand({ onClose }: SidebarBrandProps) {
  return (
    <div className="border-border from-background -mx-3 flex items-center justify-between gap-2 border-b bg-gradient-to-r to-rose-500/25 py-4 shadow-lg group-data-[state=collapsed]/sidebar:py-[0.875rem] dark:shadow-black/30">
