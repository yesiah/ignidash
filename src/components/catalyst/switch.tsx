import { Field, type FieldProps, Switch as HeadlessSwitch, type SwitchProps } from '@headlessui/react';
...
export function SwitchField({ className, ...props }: { className?: string } & Omit<FieldProps, 'as' | 'className'>) {
  return (
    <Field
      data-slot="field"
      {...props}
  ...
  return (
    <HeadlessSwitch
      ...
      className={clsx(
        ...
        // Focus
        'data-focus:outline-primary focus:not-data-focus:outline-hidden data-focus:outline-2 data-focus:outline-offset-2',
        // Hover
