    ...
    <div className="contents">
      <div className={cn('border-border/25 -mx-2 border-b sm:-mx-3 lg:-mx-4', { 'border-b-0': hideBottomBorders && !open })}>
        <DisclosureButton
          ...
          className="focus-visible:ring-primary group from-emphasized-background to-background flex w-full items-center justify-between bg-gradient-to-l px-4 py-4 hover:bg-gradient-to-r hover:to-rose-500/50 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-inset sm:py-6 lg:py-8"
