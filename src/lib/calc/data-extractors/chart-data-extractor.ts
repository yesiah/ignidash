...
export abstract class ChartDataExtractor {
  ...
  static extractSingleSimulationIncomeExpensesChartData(simulation: SimulationResult): SingleSimulationIncomeExpensesChartDataPoint[] {
  ...
  static extractSingleSimulationTaxesChartData(simulation: SimulationResult): SingleSimulationTaxesChartDataPoint[] {
    ...
    return simulation.data.slice(1).map((data) => {
      ...
      return {
        ...
        nonTaxableIncome: taxesData.incomeSources.nonTaxableIncome,
