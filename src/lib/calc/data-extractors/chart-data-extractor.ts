  ...
  static extractSingleSimulationNetWorthData(simulation: SimulationResult): SingleSimulationNetWorthChartDataPoint[] {
    return simulation.data.map((data) => {
      ...
      const {
        ...
        purchasedAssetsValue: annualPurchasedAssetsValue,
        soldAssetsValue: annualSoldAssetsValue,
        netAssetChange,
      ...
      return {
        ...
        annualPurchasedAssetsValue,
        annualSoldAssetsValue,
        netAssetChange,
        annualDebtIncurred,
        annualDebtPaydown,
  ...
  static extractSingleSimulationCashFlowData(simulation: SimulationResult): SingleSimulationCashFlowChartDataPoint[] {
    return simulation.data.slice(1).map((data) => {
      ...
      const {
        ...
        totalInterestPayments: interestPayments,
        surplusDeficit,
        amountInvested,
        amountLiquidated,
        assetPurchaseOutlay,
