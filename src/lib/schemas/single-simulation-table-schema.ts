...
const SINGLE_SIMULATION_CASHFLOW_COLUMNS = {
  ...
  totalTaxesAndPenalties: { title: 'Total Taxes and Penalties', format: 'currency' },
...
export const singleSimulationTaxesTableRowSchema = z.object({
  ...
  earlyTaxFreeEarningsWithdrawals: z.number().nullable(),
...
const SINGLE_SIMULATION_TAXES_COLUMNS = {
  ...
  earlyTaxFreeEarningsWithdrawals: { title: 'Early Tax-Free Earnings Withdrawals', format: 'currency' },
  ...
  annualTotalTaxesAndPenalties: { title: 'Annual Total Taxes and Penalties', format: 'currency' },
  cumulativeTotalTaxesAndPenalties: { title: 'Cumulative Total Taxes and Penalties', format: 'currency' },
