...
const SINGLE_SIMULATION_TAXES_COLUMNS = {
  ...
  cumulativeIncomeTaxAmount: { title: 'Cumulative Income Tax Amount', format: 'currency' },
  annualCapGainsTaxAmount: { title: 'Annual Capital Gains Tax Amount', format: 'currency' },
  cumulativeCapGainsTaxAmount: { title: 'Cumulative Capital Gains Tax Amount', format: 'currency' },
  totalAnnualTaxAmount: { title: 'Total Annual Tax Amount', format: 'currency' },
  cumulativeTaxAmount: { title: 'Cumulative Tax Amount', format: 'currency' },
