...
const SIMULATION_COLUMNS = {
  ...
  stockValue: { title: 'Stocks Value', format: 'currency' },
  stockReturn: { title: 'Stocks Return', format: 'percentage' },
  bondValue: { title: 'Bonds Value', format: 'currency' },
  bondReturn: { title: 'Bonds Return', format: 'percentage' },
