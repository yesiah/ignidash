...
export const singleSimulationNetWorthTableRowSchema = z.object({
  ...
  assetEquity: z.number().nullable(),
  securedDebtBalance: z.number().nullable(),
  unsecuredDebtBalance: z.number().nullable(),
  totalDebtBalance: z.number().nullable(),
  netWorth: z.number().nullable(),
  annualAssetAppreciation: z.number().nullable(),
  annualPurchasedAssetValue: z.number().nullable(),
  annualSoldAssetValue: z.number().nullable(),
  netAssetChange: z.number().nullable(),
  annualDebtIncurred: z.number().nullable(),
  annualDebtPaydown: z.number().nullable(),
  annualDebtPayoff: z.number().nullable(),
  netDebtReduction: z.number().nullable(),
...
const SINGLE_SIMULATION_COLUMNS = {
  ...
  assetValue: { title: 'Asset Value', format: 'currency' },
  assetEquity: { title: 'Asset Equity', format: 'currency' },
  securedDebtBalance: { title: 'Secured Debt Balance', format: 'currency' },
  unsecuredDebtBalance: { title: 'Unsecured Debt Balance', format: 'currency' },
  totalDebtBalance: { title: 'Total Debt Balance', format: 'currency' },
  netWorth: { title: 'Net Worth', format: 'currency' },
  annualAssetAppreciation: { title: 'Annual Asset Appreciation', format: 'currency' },
  annualPurchasedAssetValue: { title: 'Annual Purchased Asset Value', format: 'currency' },
  annualSoldAssetValue: { title: 'Annual Sold Asset Value', format: 'currency' },
  netAssetChange: { title: 'Net Asset Change', format: 'currency' },
  annualDebtIncurred: { title: 'Annual Debt Incurred', format: 'currency' },
  annualDebtPaydown: { title: 'Annual Debt Paydown', format: 'currency' },
  annualDebtPayoff: { title: 'Annual Debt Payoff', format: 'currency' },
  netDebtReduction: { title: 'Net Debt Reduction', format: 'currency' },
  netWorthChange: { title: 'Net Worth Change', format: 'currency' },
...
export const singleSimulationCashFlowTableRowSchema = z.object({
  ...
  debtPayments: z.number().nullable(),
  surplusDeficit: z.number().nullable(),
  amountInvested: z.number().nullable(),
  amountLiquidated: z.number().nullable(),
  assetPurchaseOutlay: z.number().nullable(),
  assetSaleProceeds: z.number().nullable(),
...
const SINGLE_SIMULATION_CASH_FLOW_COLUMNS = {
  ...
  debtPayments: { title: 'Debt Payments', format: 'currency' },
  ...
  assetPurchaseOutlay: { title: 'Asset Purchase Outlay', format: 'currency' },
  assetSaleProceeds: { title: 'Asset Sale Proceeds', format: 'currency' },
...
const SINGLE_SIMULATION_RETURNS_COLUMNS = {
  ...
  stockCagr: { title: 'Real Stock CAGR', format: 'percentage' },
  stockHoldings: { title: 'Stock Holdings', format: 'currency' },
  ...
  bondCagr: { title: 'Real Bond CAGR', format: 'percentage' },
  bondHoldings: { title: 'Bond Holdings', format: 'currency' },
  ...
  cashCagr: { title: 'Real Cash CAGR', format: 'percentage' },
  cashHoldings: { title: 'Cash Holdings', format: 'currency' },
  ...
  annualAssetAppreciation: { title: 'Annual Asset Appreciation', format: 'currency' },
  cumulativeAssetAppreciation: { title: 'Cumulative Asset Appreciation', format: 'currency' },
  historicalYear: { title: 'Historical Year', format: 'number' },
} as const;
