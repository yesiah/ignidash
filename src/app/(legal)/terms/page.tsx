          ...
          <article className="prose prose-slate prose-sm sm:prose-base max-w-none">
            ...
            <section id="ip" className="mb-8">
              ...
              <p>
                ...
                suffer because of your breach of (a) this section, (b) any third party&apos;s intellectual property rights, or (c)
                applicable law.
              </p>
            </section>
            ...
            <section id="purchases" className="mb-8">
              ...
              <p className="mb-4">
                ...
                Services. You further agree to promptly update account and payment information, including email address, payment method, and
                payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added
                to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in US dollars.
              </p>
              <p className="mb-4">
            ...
            <section id="subscriptions" className="mb-8">
              ...
              <p className="mb-4">
                ...
                applicable order. The length of your billing cycle will depend on the type of subscription plan you choose when you
            ...
            <section id="prohibited" className="mb-8">
              ...
              <ul className="ml-4 list-inside list-disc space-y-2">
                ...
                <li>
                  ...
                  prevent or restrict the use or copying of any Content or enforce limitations on the use of the Services and/or the Content
                  contained therein.
                </li>
            ...
            <section id="license" className="mb-8">
              ...
              <p>
                ...
                for your Contributions to the Services and you expressly agree to exonerate us from any and all responsibility and to
            ...
            <section id="socialmedia" className="mb-8">
              ...
              <p className="mb-4">
                ...
                login information through the Services; or (2) allowing us to access your Third-Party Account, as is permitted under the
              ...
              <p className="mb-4">
                ...
                lists and (2) we may submit to and receive from your Third-Party Account additional information to the extent you are
              ...
              <p className="mb-4">
                ...
                your account on the Services. Please note that if a Third-Party Account or associated service becomes unavailable or our
                access to such Third-Party Account is terminated by the third-party service provider, then Social Network Content may no
                longer be available on and through the Services.
              </p>
              <p className="mb-4">
                You will have the ability to disable the connection between your account on the Services and your Third-Party Accounts at
                any time. PLEASE NOTE THAT YOUR RELATIONSHIP WITH THE THIRD-PARTY SERVICE PROVIDERS ASSOCIATED WITH YOUR THIRD-PARTY
                ACCOUNTS IS GOVERNED SOLELY BY YOUR AGREEMENT(S) WITH SUCH THIRD-PARTY SERVICE PROVIDERS.
              </p>
              <p className="mb-4">
                We make no effort to review any Social Network Content for any purpose, including but not limited to, for accuracy,
                legality, or non-infringement, and we are not responsible for any Social Network Content. You acknowledge and agree that we
                may access your email address book associated with a Third-Party Account and your contacts list stored on your mobile device
                or tablet computer solely for purposes of identifying and informing you of those contacts who have also registered to use
                the Services.
              </p>
              <p>
            ...
            <section id="thirdparty" className="mb-8">
              ...
              <p className="mb-4">
                ...
                not imply approval or endorsement thereof by us. If you decide to leave the Services and access the Third-Party Websites or
                to use or install any Third-Party Content, you do so at your own risk, and you should be aware these Legal Terms no longer
                govern.
              </p>
              <p className="mb-4">
            ...
            <section id="sitemanage" className="mb-8">
              ...
              <p>
                ...
                from the Services or otherwise disable all files and content that are excessive in size or are in any way burdensome to our
                systems; and (5) otherwise manage the Services in a manner designed to protect our rights and property and to facilitate the
            ...
            <section id="ppyes" className="mb-8">
              ...
              <p className="mb-4">
                ...
                be advised the Services are hosted in the United States, Germany and Singapore.
              </p>
              <p>
                If you access the Services from any other region of the world with laws or other requirements governing personal data
                collection, use, or disclosure that differ from applicable laws in the United States, Germany and Singapore, then through
                your continued use of the Services, you are transferring your data to the United States, Germany and Singapore, and you
                expressly consent to have your data transferred to and processed in the United States, Germany and Singapore.
              </p>
            </section>
            ...
            <section id="terms" className="mb-8">
              ...
              <p className="mb-4">
                ...
                OF THE SERVICES (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO ANY PERSON FOR ANY REASON OR FOR NO REASON, INCLUDING WITHOUT
                LIMITATION FOR BREACH OF ANY REPRESENTATION, WARRANTY, OR COVENANT CONTAINED IN THESE LEGAL TERMS OR OF ANY APPLICABLE LAW
                OR REGULATION.
              </p>
              <p className="mb-4">
            ...
            <section id="disputes" className="mb-8">
              ...
              <p className="mb-4">
                ...
                required by the applicable AAA rules or applicable law, the arbitration will take place in Hennepin, Minnesota.
              </p>
              <p className="mb-4">
              ...
              <p className="mb-4">
                ...
                state and federal courts located in Hennepin, Minnesota, and the Parties hereby consent to, and waive all defenses of lack
              ...
              <p>
                ...
                or unauthorized use; and (c) any claim for injunctive relief. If this provision is found to be illegal or unenforceable,
            ...
            <section id="disclaimer" className="mb-8">
              ...
              <p>
                ...
                PARTICULAR PURPOSE, AND NON-INFRINGEMENT. WE MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE
                ...
                PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE SERVICES, (3) ANY UNAUTHORIZED
                ...
                (4) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE SERVICES, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE
                WHICH MAY BE TRANSMITTED TO OR THROUGH THE SERVICES BY ANY THIRD PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT
                AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF ANY CONTENT POSTED, TRANSMITTED, OR
            ...
            <section id="liability" className="mb-8">
              ...
              <p>
                ...
                THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE SIX
                (6) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR $250.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT
                ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO YOU, SOME
            ...
            <section id="indemnification" className="mb-8">
              ...
              <p>
                ...
                harmful act toward any other user of the Services with whom you connected via the Services. Notwithstanding the foregoing,
            ...
            <section id="electronic" className="mb-8">
              ...
              <p>
                ...
                DELIVERY OF NOTICES, POLICIES, AND RECORDS OF TRANSACTIONS INITIATED OR COMPLETED BY US OR VIA THE SERVICES. You hereby
            ...
            <section id="addclausec" className="mb-8">
              ...
              <p>
                ...
                up-to-date. Ignidash does not verify the accuracy of user inputs, and any outputs are only as reliable as the data you
                enter.
              </p>
            </section>
